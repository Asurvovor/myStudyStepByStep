...
(function (window, undefined) {
    ...
    sinaadToolkit.url = sinaadToolkit.url || /** @lends sinaadToolkit.url */{
        ...
        fortp: function (el, e) {
            ...
            if (link.indexOf('//sax.sina.com.cn') !== -1) {
...
(function (core, view) {
    ...
    view.register('embed', function (element, width, height, content, config) {
        ...
        ad_logo_update_IAB.style.cssText = 'width:26px;height:13px;position:absolute;right:1px;bottom:1px;z-index:99;background:url("http://d2.sina.com.cn/litong/zhitou/sinaads/release/ad_logo_update_IAB.gif") no-repeat';
        ...
        else if(src[0].indexOf('http://d3.sina.com.cn/litong/zhitou/sinaads/release/picshow_new.swf') > 0){
            //用来判断翻牌广告添加广告标识
            element.appendChild(ad_logo_update_IAB);
        }
        ...
        content = [
            {
                src : [
                    core.swf.createHTML({
                        ...
                        url : 'http://d3.sina.com.cn/litong/zhitou/sinaads/release/picshow_new.swf', //这个url被用作判断翻牌广告添加广告标识的ID,判断逻辑在embed.js
                        width : width,
                        height : height,
                        wmode : 'transparent',
                        vars : {
