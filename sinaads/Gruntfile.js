...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint : {
      ...
      files: ['src/*.js', 'src/plus/*.js', 'src/spec/*.js', '!src/currentScript.js'],
    },
    uglify: {
      options : {
        report : 'gzip',
      ...
      sinaPlistaAD : {
        files : [
          { dest : 'release/spec/sinaPlistaAD.js',  src : 'src/spec/sinaPlistaAD.source.js' }
        ]
      }
    },
    copy: {
  ...
  // Default task.
  grunt.registerTask('default', ['smash', 'jshint', 'concat', 'uglify', 'copy', 'clean', 'watch']);
  grunt.registerTask('nowatch', ['jshint', 'concat', 'uglify', 'clean']);
