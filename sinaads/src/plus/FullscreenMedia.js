...
(function (window, sinaadToolkit, mediaControl, undefined) {
    ...
    var MAIN_CLOSE_BTN = '//d2.sina.com.cn/litong/zhitou/sinaads/77x31-close.gif',
        MINI_CLOSE_BTN = '//d3.sina.com.cn/d1images/fullscreen/close.gif',
        REPLAY_BTN = '//d2.sina.com.cn/litong/zhitou/sinaads/release/fullscreen_replay_btn.swf',
        height = 0,
        SHOW_COUNT = 2; //自动显示次数;
    ...
    function FullscreenMedia(config) {
        ...
        if (config.hasClose) {
            ...
            miniContent.style.cssText = 'position:absolute;left:0px;top:0px;overflow:hidden;margin:0;padding:0';
            ...
            if (config.replaySrc) {
                ...
                sinaadToolkit.swf.hackAutoPlay(
                    miniContent,
                    sinaadToolkit.swf.createHTML({
                        url : REPLAY_BTN,
                        width : 25,
                        height : 100,
                        wmode : 'transparent',
