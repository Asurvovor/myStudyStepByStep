...
(function (window, sinaadToolkit, mediaControl, undefined) {
    ...
    //常量定义
    var //SIDE_CLOSE_BTN = "//d2.sina.com.cn/d1images/lmt/close2.gif",
        SIDE_CLOSE_BTN = '//d2.sina.com.cn/litong/zhitou/sinaads/60x18_1_close.gif',
        SIDE_CLOSE_BTN_SIZE = [60, 18],
        SIDE_SIZE = [120, 300],
