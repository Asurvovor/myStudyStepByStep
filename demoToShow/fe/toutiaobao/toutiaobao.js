...
//    }
    ...
    if(!new Schedule('2016-11-23~2016-12-30').check()){
        return false;
    }
    sinaadToolkit.sio.loadScript('//d3.sina.com.cn/litong/zhitou/sinaads/demo/jiliang/toutiaobao/simulate/toutiaobaoMedia.js', function() {
