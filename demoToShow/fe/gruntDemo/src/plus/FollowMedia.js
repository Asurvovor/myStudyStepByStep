...
(function (window, sinaadToolkit, undefined) {
    ...
    var MINI_REPLAY_BTN = '//d5.sina.com.cn/d1images/lmt/play.gif',
        MINI_CLOSE_BTN = '//d2.sina.com.cn/litong/zhitou/sinaads/25x65_1-close.gif',
        MAIN_CLOSE_BTN = '//d2.sina.com.cn/litong/zhitou/sinaads/60x18_1_close.gif',
        MAIN_CLOSE_BTN_SIZE = [60, 18],
        MINI_CONTENT_SIZE = [25, 150],
        MINI_REPLAY_BTN_SIZE = [25, 24],
        MINI_CLOSE_BTN_SIZE = [25, 65];
